...
<head>
  ...
  <title>Citrix XenApp - 登录</title>
  <link rel="SHORTCUT ICON" href="../media/IcaComboAll.ico" type="image/vnd.microsoft.icon">
  <link rel="stylesheet" type="text/css"  media="handheld,all" href="style.aspx?cacheString=zh_CN++Normal++VkLXMViRb8mDIfopj2Ec4C++PaYr7o6XGmp+YoJ/46EyDD" >
    <script type="text/javascript" src="javascript.aspx?cacheString=zh_CN++Normal++VkLXMViRb8mDIfopj2Ec4C++PaYr7o6XGmp+YoJ/46EyDD"></script>
  <script type="text/javascript">
    ...
    function getFrameSuffix() {
      return "WI_qnVVOc7OH1XqyJe6x";
    }
    function getSessionToken() {
      return "3207401B68856435EE80EDA1FD11B022";
    }
    // -->
  </script>
  <script type="text/javascript">
...
function storeCookie(name, value) {
    ...
    cookie = cookie + "; path=/Citrix/AG/auth/";
...
<input type="hidden" name="SESSION_TOKEN" value="3207401B68856435EE80EDA1FD11B022" >
        ...
        <td>
          <table id="headerRight" cellspacing="0">
            <tr>
              ...
              <td >
                <a id="settingsLink" class="navLink" href="loginSettings.aspx"><span>设置</span></a>
              </td>
              ...
              <td>
                <img id="headerLogo" src="../media/CitrixLogoHeader.png" alt="页面标题" title="">
              </td>
...
<tr><td colspan="2" class="loginButtonPane">
      ...
      <div class="customButton loginButton"><a
           class="leftDoor" href="javascript:submitForm()" title="单击此处后登录"
           id="btnLogin"
           name="btnLogin"
        ><span class="rightDoor">登录</span></a>
      </div>
...
<div id="sysMessage">
     ...
     <!-- -->
        ...
        <h3 id="horizonTagline">您的 Windows 桌面和按需应用程序 - 在任何 PC、Mac、智能手机或掌上电脑中都能找到。</h3>
      </div>
    </div>
...
<div id="footer">
  <a href="http://www.citrix.com"
    ><img src="../media/CitrixWatermark.png" alt="应用程序虚拟化" title=""></a>
  <a href="http://hdx.citrix.com"
    ><img id="hdxLogo" src="../media/HDX.png" alt="HDX - 高清用户体验" title=""></a>

</div>


  </div> 
    <iframe width="0" height="0" class="HiddenIframe" id="timeoutFrameWI_qnVVOc7OH1XqyJe6x" name="timeoutFrameWI_qnVVOc7OH1XqyJe6x" title="会话超时功能的隐藏帧" src="../html/dummy.html"></iframe>
